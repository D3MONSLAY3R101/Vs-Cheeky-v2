...
class ResultsScreen extends FlxSubState
{
	...
	{
        if (music.volume < 0.5 && musicplayy == true)
            ...
            if (PlayState.isStoryMode)
            {
				switch(PlayState.PREVSONG.toLowerCase())
				{
					...
					case 'hard 2 break':
						...
						LoadingState.loadAndSwitchState(new VideoState("assets/videos/cutscene3/cutscenefinal.webm", new StoryMenuState()));
					default:
